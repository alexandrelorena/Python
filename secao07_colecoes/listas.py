...
print('----------------------------- Checar valor em uma lista ------------------------------ ')
...
print('----------------------------- Contar elementos da lista ------------------------------ ')
...
print('----------------------------- Remover último elemento da lista ------------------------------ ')
print(lista5)
lista5.pop()  # Além de remover o último elemento, retorna esse elemento
print(lista5)

print('----------------------------- Remover índice da lista ------------------------------ ')
print(lista5)
...
print('----------------------------- Repetir elementos na lista ------------------------------ ')
nova = [1, 2, 3]
print(nova)
nova = nova * 3
print(nova)
...
print('----------------------------- Converter Lista para String ------------------------------ ')
...
for produto in carrinho:
    print(produto)
"""
print('----------------------------- Valores fixos e variáveis ------------------------------ ')
numeros = [1, 2, 3, 4, 5]
print(numeros)
...
print('----------------------------- acessando elementos de forma inversa ------------------------------ ')
#           0         1        2         3
cores = ['verde', 'amarelo', 'azul', 'branco']
#           -4        -3       -2       -1
print(cores[-1])

print('----------------------------- Gerar índice em um for ------------------------------ ')

cores = ['verde', 'amarelo', 'azul', 'branco']
for indice, cor in enumerate(cores):
    print(indice, cor)

print('----------------------------- Encontrar um índice de um elemento na lista ------------------------------ ')
...
print('----------------------------- Copiando uma lista - Deep copy ------------------------------ ')
...
print(lista)
print(nova)
print('----------------------------- Copiando uma lista - Shallow copy ------------------------------ ')
